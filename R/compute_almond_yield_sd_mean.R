...
#'
#'
compute_almond_yield_sd_mean = function(clim,Tmincoeff1=-0.015, Tmincoeff2=-0.0046, Pcoeff1=-0.07, Pcoeff2=0.0043, intercep=0.28) {
  ...
  return(list(meanyield=mean(yield), sdyield=sd(yield)))
}
